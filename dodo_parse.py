...
def read_menu():
    ...
    # drinks_cut_description_unfiltered = []
    cut_description = []
    ...
    # p = 0
    # while p < len(drinks_description):
    #     for item in drinks_title:
    #         if len(drinks_description) != 0:
    #             drinks_cut_description_unfiltered.append(drinks_description[p][len(item):])
    #         p += 1
    # drinks_cut_description = list(filter(None, drinks_cut_description_unfiltered))
...
def print_request_menu(ingredience):
